...
import com.wkj.project.config.rabbitmq.RabbitMqConfig;
...
//        rabbitTemplate.convertAndSend(RabbitMqConfig.FANOUT_EXCHANGE, "", "广播者模式测试",cId);
        Object object = rabbitTemplate.convertSendAndReceive(RabbitMqConfig.FANOUT_EXCHANGE, "", "广播者模式测试", cld);
    ...
    public void sendMqExchange() {
        ...
        log.info("订阅者模式->发送消息：routing_key_two");
